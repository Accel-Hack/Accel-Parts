...
public class Response<E> {
  ...
  static class Builder<B> {
    ...
    Response.Builder<B> operationKey(Integer operationKey) {
      this.operationKey = operationKey;
      return this;
    }

    Response.Builder<B> operationStatus(Boolean operationStatus) {
      this.operationStatus = operationStatus;
      return this;
    }

    Response.Builder<B> errors(List<ResponseError> errors) {
      this.errors = errors;
      return this;
    }

    Response.Builder<B> result(B result) {
      this.result = result;
      return this;
    }
